...
def main():
    ...
    holdout_idx = pd.read_csv(holdout_idx_path).squeeze().values
    ...
    for seed in seeds:
        ...
        scenario = ens_bundle.get("scenario", "IncidentPlusPrevalent")
        ...
        y_true = (df_holdout[TARGET_COL] == positive_label).astype(int).values
