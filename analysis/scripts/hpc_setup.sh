...
echo "Next steps:"
echo ""
echo "Option A: Run pipeline (venv activation handled automatically)"
echo "  Local testing:"
echo "    ./run_local.sh"
echo ""
echo "  HPC production:"
...
echo "    ./run_hpc.sh"
echo ""
echo "Option B: Interactive CLI usage (manual activation required)"
...
echo "     ced --help"
echo ""
echo "  3. Run commands interactively:"
echo "     ced save-splits --help"
echo "     ced train --help"
echo ""
echo "Configuration:"
