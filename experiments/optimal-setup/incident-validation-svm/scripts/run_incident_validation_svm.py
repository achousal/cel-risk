...
Usage:
  cd cel-risk
  python experiments/optimal-setup/incident-validation-svm/scripts/run_incident_validation_svm.py
  python experiments/optimal-setup/incident-validation-svm/scripts/run_incident_validation_svm.py --smoke
"""
