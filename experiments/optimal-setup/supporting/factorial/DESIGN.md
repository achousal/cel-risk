...
See [analyze_factorial_2x2x2.py](experiments/optimal-setup/supporting/factorial/analyze_factorial_2x2x2.py) for:
...
Example analysis:
```bash
python experiments/optimal-setup/supporting/factorial/analyze_factorial_2x2x2.py \
...
```bash
python experiments/optimal-setup/supporting/factorial/test_parallel.py
```
