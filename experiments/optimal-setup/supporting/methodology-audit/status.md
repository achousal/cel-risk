...
**Date**: 2026-02-08
**Audit Reference**: mathematical validity audit, section 5C
**Scripts Location**: `experiments/optimal-setup/supporting/methodology-audit/scripts/`
...
```bash
cd /path/to/cel-risk/experiments/optimal-setup/supporting/methodology-audit/scripts
...
cd experiments/optimal-setup/supporting/methodology-audit/scripts
...
After running studies on real pipeline data, update the mathematical validity audit note under `docs/dev/notes/`:
...
- **Audit Document**: centralize into `docs/dev/notes/` when the audit note is restored
- **Scripts README**: `experiments/optimal-setup/supporting/methodology-audit/DESIGN.md`
