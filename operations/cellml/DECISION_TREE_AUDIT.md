...
| Methodology: Vanillamax discovery | **Documented.** Discovery should use all cases, all controls, no weighting, no downsampling for maximum sensitivity. Gen1 used restricted settings (frac=0.5, 5:1 controls, log weights). BH core (4p) robust; 8p boundary may shift. V0+V1 compensate. New datasets should run vanillamax. | 2026-04-08 | DESIGN.md + MASTER_PLAN.md updated with principle and Gen1 caveat. |
